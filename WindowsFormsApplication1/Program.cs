    ...
    public class Program : Form
    {
        ...
        void Program_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            switch (e.KeyData)
            {
                ...
                case Keys.P:
                    ...
                    break;
                case Keys.O:
                    timer.Interval = timer.Interval > 10 ? timer.Interval - 10 : 1;
                    break;
        ...
        void timer_Tick(object sender, EventArgs e)
        {
            ...
            if (snake[0].X == apple.X && snake[0].Y == apple.Y) // если координаты головы и яблока совпали
            {
                ...
                var free = world.Except(snake).ToList();
                apple = free[rand.Next(free.Count - 1)];
                ...
                if (apples % 10 == 0) // после каждого десятого яблока
                {
                    ...
                    timer.Interval = timer.Interval > 11 ? timer.Interval - 10 : timer.Interval; // и уменьшаем интервал срабатывания яблока
                }
            }
